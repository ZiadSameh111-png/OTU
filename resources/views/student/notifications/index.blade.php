                                ...
                                <div class="d-flex align-items-center">
                                    <div class="notification-icon me-3">
                                        ...
                                        @elseif($notification['type'] == 'request')
                                            <span class="badge rounded-circle bg-warning p-3"><i class="fas fa-clipboard-list"></i></span>
                                        @elseif($notification['type'] == 'fee')
                                            <span class="badge rounded-circle bg-success p-3"><i class="fas fa-money-bill-wave"></i></span>
                                        @else
