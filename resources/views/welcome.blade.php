        ...
        <div class="container">
            <div class="row min-vh-100 justify-content-center align-items-center">
                <div class="col-md-8 text-center">
                    <h1 class="display-4 mb-4">Smart University System</h1>
                    <p class="lead mb-5">Welcome to our modern learning management platform</p>
                    <div class="d-flex justify-content-center gap-3">
                        @if (Route::has('login'))
                            @auth
                                <a href="{{ url('/home') }}" class="btn btn-primary px-4 py-2">Dashboard</a>
                            @else
